module ActiveScaffold
  module Helpers
    module ViewHelpers
      # Add the aal plugin includes
      def active_scaffold_includes_with_aal(frontend = :default) 
        css = stylesheet_link_tag(ActiveScaffold::Config::Core.asset_path('aal-stylesheet.css', frontend))
        ie_css = stylesheet_link_tag(ActiveScaffold::Config::Core.asset_path('aal-stylesheet-ie.css', frontend))
